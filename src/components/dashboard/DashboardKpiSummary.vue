<template>
  <div class="bg-white rounded-lg shadow-sm border p-4">
    <h3 class="text-lg font-semibold text-gray-900 mb-4">Dashboard Summary</h3>
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div class="text-center">
        <div class="text-2xl font-bold text-green-600">{{ hotLeads }}</div>
        <div class="text-sm text-gray-600">Hot Leads</div>
      </div>
    </div>

    <div class="mt-4 text-xs text-gray-500">Last updated: {{ lastUpdated }}</div>
  </div>
</template>
